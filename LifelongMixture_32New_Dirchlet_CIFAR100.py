...
cifar100_x_train = cifar100_x_train / 255.0
cifar100_x_test = cifar100_x_test / 255.0
...
def MyTest():
    ...
    with tf.Session(config=config) as sess:
        ...
        saver.restore(sess, 'models/LifelongMixture_32New_Dirichlet_CIFAR100')
        currentTask = 1
...
with tf.Session(config=config) as sess:
    ...
    saver.save(sess, 'models/LifelongMixture_32New_Dirichlet_CIFAR100')
